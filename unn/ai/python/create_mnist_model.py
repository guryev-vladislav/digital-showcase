...
MODEL_SUBDIR = f'model_cnn_v{MODEL_VERSION}'  # Обновляем поддиректорию для CNN
...
MODEL_PATH = os.path.join("mnist_model", 'mnist_cnn_model_v'+str(MODEL_VERSION)+'.keras')  # Обновляем имя файла модели
...
model_cnn = Sequential([
    Input(shape=(28, 28, 1)),  # Добавлен канал (1 для черно-белых изображений)
...
# Обучение CNN модели
print("Начинаем обучение CNN модели...")
